...
namespace server
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IHostApplicationLifetime applicationLifetime)
        {
            ...
            var computeService = app.ApplicationServices.GetService<ComputeService>();
            computeService.Start();

            var shutdownService = app.ApplicationServices.GetService<ShutdownService>();
            applicationLifetime.ApplicationStopped.Register(shutdownService.Shutdown);
        }
